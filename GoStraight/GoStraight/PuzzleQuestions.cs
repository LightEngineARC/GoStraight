...
namespace GoStraight
{
    class PuzzleQuestions
    {
        ...
        public static Puzzle[] PuzzleArray()
        {
            ...
            String[] mazeFileName = { "KMaze", "Maze", "MazeAC", "MazeKW", "MyMaze", "MyMazeExpanded" };

            // puzzles for jae's maze
            ...
            Puzzle puzzle4 = new Puzzle(mazeFileName[3], coordinate4, false,
            ...
            Puzzle puzzle6 = new Puzzle(mazeFileName[4], coordinate3, true,
